    ...
    <main id="home-top" tabIndex={-1} style={{ display: 'grid', gap: 14, scrollMarginTop: 24 }}>
      ...
      <div className="pf-card" style={{ display: 'grid', gap: 10 }}>
        ...
        <div className="pf-dim" style={{ fontSize: 11 }}>
          Jump straight to the live action blocks instead of scanning the whole dashboard. Use Alt+0-9 for the primary operator path, Alt+D for Desk watchlist, Alt+L for Leaderboard, Alt+P for Desk participation, Alt+U for Pulse board, and Alt+R for Market regime. Home / End snap to the first or last section, [ / ] or J / K step section-by-section, C copies the link for the section currently in view, and Resume jumps back to the last section you were reading.
        </div>
