    ...
    <main id="home-top" tabIndex={-1} style={{ display: 'grid', gap: 14, scrollMarginTop: 24 }}>
      ...
      <div className="pf-card" style={{ display: 'grid', gap: 10 }}>
        ...
        <div className="pf-dim" style={{ fontSize: 11 }}>
          Jump straight to the live action blocks instead of scanning the whole dashboard. Use Alt+0-9 for the primary operator path, Alt+D for Desk watchlist, Alt+L for Leaderboard, Alt+P for Desk participation, Alt+U for Pulse board, and Alt+R for Market regime. Tap / to filter the jump rail, use ↑ / ↓ to choose among filtered matches, press Enter to jump to the selected match, and Esc to clear the filter. Home / End snap to the first or last section, [ / ] or J / K step section-by-section, C copies the link for the section currently in view, O opens that direct link in a new tab, and R or Resume jumps back to the last section you were reading. The progress rail now keeps both the saved last stop and a short recent trail, so you can bounce between the last few sections you touched without re-running the filter.
        </div>
